...
export function Leetcode({ size = 16, className = "" }) {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      <path d="M12 13h7.5" />
      <path d="M9.424 7.268l4.83 -4.83a2.914 2.914 0 0 1 4.12 0l.542 .542a2.914 2.914 0 0 1 0 4.12l-4.83 4.83" />
      <path d="M16.5 16.5l-4.5 4.5a3 3 0 0 1 -4.242 0l-4.5 -4.5a3 3 0 0 1 0 -4.242l4.5 -4.5" />
    </svg>
  );
}
